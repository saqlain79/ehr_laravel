        ...
        <div class="container-fluid d-flex align-items-center justify-content-between">
          <div class="navbar-header">
            <!-- Navbar Header--><a href="{{route('home')}}" class="navbar-brand">
              <div class="brand-text brand-big visible text-uppercase"><strong class="text-primary">EHR</strong><strong>SYSTEM</strong></div>
              <div class="brand-text brand-sm"><strong class="text-primary">EHR</strong><strong>S</strong></div></a>
            <!-- Sidebar Toggle Btn-->
          ...
          <div class="right-menu list-inline no-margin-bottom">    
            ...
            <div class="list-inline-item"><a href="{{route('patientdata',auth()->user()->id)}}" class="nav-link text-gray-light">My Dashboard</a></div>
            @endif
            ...
            <div class="list-inline-item logout">
              <form action="{{route('logout')}}" method="post">
                ...
                <button type="submit" id="logout" class="nav-link text-gray-light bg-transparent" style="border:none">Logout <i class="icon-logout"></i></button>
